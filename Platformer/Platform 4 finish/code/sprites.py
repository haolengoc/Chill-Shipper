...
class Fire(Sprite):
    def __init__(self, surf, pos, groups, player):
        ...
        self.y_offset = pygame.Vector2(-15,7)
        if self.player.flip:
...
class Player(AnimatedSprite):
    ...
    def become_red(self):
        red_surface = self.image.copy()  # Sao chép bề mặt hiện tại
        red_surface.fill((255, 0, 0), special_flags=pygame.BLEND_RGBA_MULT)  # Áp dụng hiệu ứng đỏ
        self.image = red_surface  # Gán lại bề mặt đã chỉnh sửa
